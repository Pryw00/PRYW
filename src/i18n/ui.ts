...
export const ui = {
  es: {
    ...
    'lightbox.label': 'Galería de imágenes',
    'lightbox.prev': 'Imagen anterior',
    'lightbox.next': 'Imagen siguiente',
    'cursor.gallery': 'Galería',
    'status.viewGallery': 'Ver galería',
    'project.gallery': 'Galería',
    'clients.shotCaption': 'Captura del sitio',
  ...
  en: {
    ...
    'cursor.gallery': 'Gallery',
    'status.viewGallery': 'View gallery',
    'project.gallery': 'Gallery',
    'clients.shotCaption': 'Website screenshot',
    'cursor.write': 'Write',
  },
} as const;
